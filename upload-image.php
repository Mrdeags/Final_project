...
if(isset($_POST["image"])){
    ...
    $imageName = "/FINAL/assets/images/".$randomNumber.'.png'; //setting image location (For img src for displaying image on the page), this can be relative
    $directory = $_SERVER['DOCUMENT_ROOT']."/FINAL/assets/images/".$randomNumber. '.png'; //Setting absolute directory on the server with
